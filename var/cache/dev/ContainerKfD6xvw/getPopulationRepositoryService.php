 ...
 */
class getPopulationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PopulationRepository' shared autowired service.
     *
     * @return \App\Repository\PopulationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PopulationRepository.php';

        return $container->privates['App\\Repository\\PopulationRepository'] = new \App\Repository\PopulationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
