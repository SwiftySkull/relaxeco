...
/* base.html.twig */
class __TwigTemplate_e4ea2deb616003a8dc0b403e9eb170c6bfe4f8eca87d34aa067f552234fccc72 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_homeActive($context, array $blocks = [])
    {
        $macros = $this->macros;
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "homeActive"));
    ...
    public function block_accueilActive($context, array $blocks = [])
    {
        $macros = $this->macros;
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "accueilActive"));
    ...
    {
        return array (  255 => 54,  243 => 42,  231 => 39,  219 => 33,  207 => 30,  195 => 27,  185 => 14,  178 => 13,  168 => 10,  161 => 9,  148 => 5,  135 => 55,  133 => 54,  124 => 47,  117 => 42,  109 => 39,  106 => 38,  99 => 33,  91 => 30,  83 => 27,  70 => 16,  68 => 13,  65 => 12,  63 => 9,  60 => 8,  55 => 5,  49 => 1,);
    }
    ...
    <body>
        <nav class=\"navbar navbar-expand-lg navbar-light bg-light\">
            <div class=\"container-fluid\">
                ...
                <ul class=\"navbar-nav\">
                    <li class=\"nav-item\">
                        <a class=\"nav-link {% block homeActive %}{% endblock %}\" aria-current=\"page\" href=\"{{ path('home') }}\">Home</a>
                    </li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link {% block accueilActive %}{% endblock %}\" href=\"{{ path('home_page_browse') }}\">Page d'accueil</a>
                    </li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link {% block seancesActive %}{% endblock %}\" href=\"{{ path('seances_browse') }}\">Séances</a>
                    </li>
                    {# <li class=\"nav-item {% block populationActive %}{% endblock %}\">
                        <a class=\"nav-link\" href=\"{{ path('population_browse') }}\">Population</a>
                    </li> #}
                    <li class=\"nav-item\">
                        <a class=\"nav-link {% block literatureActive %}{% endblock %}\" href=\"{{ path('literature_browse') }}\">Poésies</a>
                    </li>
                    <li class=\"nav-item\">
                        <a class=\"nav-link {% block quotesActive %}{% endblock %}\" href=\"{{ path('quotes_browse') }}\">Citations</a>
                    </li>
                    {# <li class=\"nav-item {% block textStyleActive %}{% endblock %}\">
                        <a class=\"nav-link\" href=\"{{ path('text_style_browse') }}\">Genre</a>
                    </li> #}
                </ul>
                </div>
            </div>
...
", "base.html.twig", "C:\\Users\\Utilisateur\\Desktop\\Projets\\Relax&Co\\Back\\templates\\base.html.twig");
    }
}
